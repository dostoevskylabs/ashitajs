    ...
    */
    switch ( data.type ) {
      ...
      case "connectionEstablished":
          ...
          messages.sendPeerJoinMessage( peerManager.generatePeerId(this.publicKey), peerManager.getPeerId );
      ...
      case "peerJoined":
        ...
        messages.sendPeerJoinMessage( data.content.newPeerId, data.content.originatingPeerId );
      break;
      ...
      case "publicMessage":
        ...
        a  `x_\         /_x`-----|   |
           ...
           *
          **/
          let message = crypto.publicDecrypt(manifest.getPublicKeyOfPeer( data.content.peerId[0] ), Buffer.from(data.content.message, 'utf-8'));
          cli.Panel.publicMessage( data.content.peerId[0], data.content.username, message.toString() );

          peerManager.relayPublicMessage(data.content.peerId, data.content.username, message.toString());
        };
      break;
