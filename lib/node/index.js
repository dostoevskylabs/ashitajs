...
class AshitaNode extends net.Server {
  ...
  onClose ( error ) {
    // this.publicKey is the last peer that joined dufus
  }
  ...
  onData ( data ) {
    ...
    if ( messages.hasMessage ( data.messageId ) ) {
      ...
      */
      switch ( data.type ) {
        case "alreadyRouted":
          router.addRoute( data.content.originatingPeerId, data.content.peerId );
        break;
        ...
        case "connectionEstablished":
            ...
            messages.sendPeerJoinMessage( peerManager.generatePeerId(this.publicKey), peerManager.getPeerId, peerManager.getPeerId, this.publicKey);
        break;
        ...
        case "peerJoined":
          if ( data.content.newPeerId !== peerManager.getPeerId ) {
            ...
            manifest.addEntry( data.content.newPeerId, data.content.publicKey );
          ...
          messages.sendPeerJoinMessage( data.content.newPeerId, data.content.originatingPeerId, peerManager.getPeerId, data.content.publicKey );
        break;
        ...
        case "disconnecting":
          ...
          messages.sendPeerDisconnectMessage( data.content.peerId, data.content.relayingPeerId );
        ...
        case "publicMessage":
          ...
          a  `x_\         /_x`-----|   |
            ...
            **/
            ...
            messages.sendPublicMessage( data.content.originatingPeerId, data.content.relayingPeerId, data.content.username, message.toString(), data.messageId );
          };
        break;
